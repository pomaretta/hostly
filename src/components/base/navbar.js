						...
						<div className="w-full px-2 sm:px-3 lg:px-5 | h-full | flex items-center">
							<div className="relative flex items-center justify-between | w-full h-full">
								<div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
									<h1 className='font-bold | text-4xl | flex items-center justify-start'>
										{
											this.props.title
										}
										{
											this.props.title ?
												(
													<span className='ml-6 px-2 py-1 border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white dark:hover:bg-white dark:hover:text-black dark:border-white dark:text-white | rounded-lg | text-sm | cursor-pointer'>
														{
								...
								<div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 | space-x-4">
									...
									{/* <div className="dropdown dropdown-end">
										...
										<ul tabindex="1" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-80 | dark:bg-black dark:border-2 dark:border-blue-500">
											<li>
