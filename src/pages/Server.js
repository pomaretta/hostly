                    ...
                    >
                        ...
                        <ul className="w-full h-full | flex flex-col justify-between items-start">
                            ...
                            <div className="mt-auto flex flex-col w-full">
                                <li className="w-full">
                                    <a className="flex items-center justify-center text-lg | px-4 py-2 | bg-transparent | border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white | w-full | rounded-lg | font-bold">
                                        Remove
                                    </a>
                                </li>
                            </div>
